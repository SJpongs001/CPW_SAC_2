...
export default function FAQ01() {
        ...
        const [Answer , setAnswer] = useState([""]);
              ...
              Axios.get('http://localhost:3001/faq1').then((response) => {
        ...
        const deleteFAQ = (faq_id) => {
          Axios.delete(`http://localhost:3001/delete1/${faq_id}`).then((response) => {
            setFaq(
              faq.filter((val) => {
    ...
    return(
        ...
        <Box sx={style}>
          ...
          <Grid container justifyContent="center" >
            <Button variant="contained" color="success" sx={{m:3}} onClick={addFAQ2} >
            Add FAQ
