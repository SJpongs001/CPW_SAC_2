...
export default function FAQ05() {
        ...
        const [Answer , setAnswer] = useState([""]);
              ...
              Axios.get('http://localhost:3001/faq5').then((response) => {
                setFaq(response.data);
              });

            
              const addFAQ5 = () => {
                Axios.post('http://localhost:3001/create5', {
                  Question: Question,
                  Answer: Answer
                })
                  .then(() => {
        ...
        const deleteFAQ = (faq_id) => {
          Axios.delete(`http://localhost:3001/delete5/${faq_id}`).then((response) => {
            setFaq(
              faq.filter((val) => {
    ...
    return(
        ...
        <Box sx={style}>
          ...
          <Grid container justifyContent="center" >
            <Button variant="contained" color="success" sx={{m:3}} onClick={addFAQ5} >
            Add FAQ
