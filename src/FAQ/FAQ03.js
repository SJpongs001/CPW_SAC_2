...
export default function FAQ03() {
        ...
        const [Answer , setAnswer] = useState([""]);
              ...
              Axios.get('http://localhost:3001/faq3').then((response) => {
                setFaq(response.data);
              });

            
              const addFAQ3 = () => {
                Axios.post('http://localhost:3001/create3', {
                  Question: Question,
                  Answer: Answer
                })
                  .then(() => {
        ...
        const deleteFAQ = (faq_id) => {
          Axios.delete(`http://localhost:3001/delete3/${faq_id}`).then((response) => {
            setFaq(
              faq.filter((val) => {
    ...
    return(
        <div>
            ...
            <Grid container spacing={1} sx={{p:2}} >
                ...
                <Typography gutterBottom variant="h6" component="div" sx={{pl:5 , pt:5}}>
                    FAQ / ฝ่ายปกครองและกิจการนักเรียน
                </Typography>
                </Grid>
                <Grid sx={{p:2 , pt:4}} >
        ...
        <Box sx={style}>
          ...
          <Grid container justifyContent="center" >
            <Button variant="contained" color="success" sx={{m:3}} onClick={addFAQ3} >
            Add FAQ
